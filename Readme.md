...
* **HTML5:** Semantic structure and accessible DOM hierarchy.
* **CSS3:** Flexbox, CSS Grid, custom properties (variables), drop shadows, and responsive layouts.
* **JavaScript (ES6+):** Coordinate-based window dragging, state-driven battle loops, and offline dataset management.
